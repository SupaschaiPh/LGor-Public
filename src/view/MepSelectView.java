...
public class MepSelectView {
    ...
    private JMenuItem mitem1 = new SuComponent().getMenuItem("Back"), mitem2 = new SuComponent().getMenuItem("AddProblem");
    
    
    public MepSelectView() {
        this(300,300,200,150);
    }

    
    
    public MepSelectView(int posx,int posy,int w,int h) {
