...
public class CreateProblemView {
    ...
    public CreateProblemView(Problem pb) {
        mapEditor = new MapEditorCon(pb);
        problemEditorView.getName().setText(pb.getName());
        problemEditorView.getDesc().setText(pb.getDescription());
        problemEditorView.getAuthor().setText(pb.getAuthor());
        problemEditorView.getMustKeepItem().setText(pb.getCountMustKeepItem() + "");
        problemEditorView.getLimitComand().setText(pb.getStackCodeSize() + "");
        problemEditorView.getRank().setValue(pb.getRank());
        this.init();
